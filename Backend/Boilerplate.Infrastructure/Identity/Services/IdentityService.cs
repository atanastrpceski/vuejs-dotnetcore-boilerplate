using Boilerplate.Application.DTOs.Identity;
using Boilerplate.Application.DTOs.Mail;
using Boilerplate.Application.DTOs.Settings;
using Boilerplate.Application.Enums;
using Boilerplate.Application.Exceptions;
using Boilerplate.Application.Interfaces;
using Boilerplate.Application.Interfaces.Shared;
using Boilerplate.Infrastructure.Identity.Models;
...
namespace Boilerplate.Infrastructure.Identity.Services
{
        ...
        public async Task<Result<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _mailService.SendAsync(new MailRequest() { From = "mail@test.com", To = user.Email, Body = $"Please confirm your account by <a href='{verificationUri}'>clicking here</a>.", Subject = "Confirm Registration" });
