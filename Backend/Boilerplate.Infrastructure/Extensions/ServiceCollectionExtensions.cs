using Boilerplate.Application.Interfaces.CacheRepositories;
using Boilerplate.Application.Interfaces.Contexts;
using Boilerplate.Application.Interfaces.Repositories;
using Boilerplate.Infrastructure.CacheRepositories;
