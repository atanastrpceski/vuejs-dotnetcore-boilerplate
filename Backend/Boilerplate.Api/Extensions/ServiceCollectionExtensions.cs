...
using Boilerplate.Infrastructure.Identity.Services;
using Boilerplate.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Boilerplate.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
